...
export default class Monthly2000RentIncrease extends PureComponent {
    ...
    componentDidMount() {
        ...
        api.get_payment(movie_id)
            .then(result => {
                ...
                return result.RentAppreciation;
            })
        ...
        return (
            ...
            <ResponsiveContainer width="100%" height={500}>
                ...
                >
                    ...
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="Monthly2000RentEstimate" stroke="#7f8c8d" />
                </LineChart>
            </ResponsiveContainer>
        );
    }
