...
export default class MonthlyPaymentsVA5DownGetStarted extends React.Component {
                    ...
                    <Grid item xs={12} md={6}>
                        ...
                        <List
                            ...
                            subheader={
                                <ListSubheader component="div" id="Estimated Monthly Costs">
                                    ...
                                    <NumberFormat value={this.state.movie.VaIncomeNeeded5Down} displayType={'text'} thousandSeparator={true}  prefix={' $'} />
                                </ListSubheader>
                            }
                        ...
                        >
                            ...
                            <ListItem button>
                                ...
                                <ListItemText primary="Down Payment"  secondary=  <NumberFormat value= {this.state.movie.VADownPaymentAmount5} displayType={'text'} thousandSeparator={true}  prefix={'$'} /> />
                            </ListItem>
                            <ListItem button>

                                <ListItemText primary="Funding Fee 1.65%"  secondary=<NumberFormat value={this.state.movie.VaFundingFee5Down}  displayType={'text'} thousandSeparator={true}  prefix={'$'} /> />
                            </ListItem>


                            <ListItem button>

                                <ListItemText primary="Cash To Close"  secondary=<NumberFormat value={this.state.movie.VaCashToClose5Down}  displayType={'text'} thousandSeparator={true}  prefix={'$'} /> />
                            </ListItem>


                            <ListItem button>

                                <ListItemText primary="Loan Amount"  secondary=<NumberFormat value={this.state.movie.VaLoanAmount5Down}  displayType={'text'} thousandSeparator={true}  prefix={'$'} /> />
                            </ListItem>
                            <ListItem button>
                            ...
                            <ListSubheader component="div" id="Estimated Monthly Costs">
                                ...
                                <NumberFormat value={this.state.movie.VaMonthlyEstimatedPayments5Down} displayType={'text'} thousandSeparator={true}  prefix={' $'} />
                            </ListSubheader>
                        </List>

                    </Grid>
                    <Grid item xs={12} md={6}>
                        <MonthlyPaymentChartVa5Down />
                    </Grid>
                    <Grid item xs={12}>
