...
export default class MonthlyPaymentChartVa5Down extends React.Component {
    ...
    componentDidMount() {
        ...
        api.get_payment(movie_id)
            .then(result => {
                ...
                const VaPrincipalInterest5Down = Number(result.VaPrincipalInterest5Down);
                const PropertyTaxes = Number(result.PropertyTaxes);
                const HOAFees = Number(result.HOAFees);
                return [
                    { name: "Principal & Interest", value: VaPrincipalInterest5Down },
