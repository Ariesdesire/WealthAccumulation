...
export default class FhaMonthlyPaymentChart extends React.Component {
    ...
    componentDidMount() {
        ...
        api.get_payment(movie_id)
            .then(result => {
                ...
                const FHAPrincipalInterest = Number(result.FHAPrincipalInterest);
                const PropertyTaxes = Number(result.PropertyTaxes);
                const FHAMortgageInsurance = Number(result.FHAMortgageInsurance);
                const HOAFees = Number(result.HOAFees);
                return [
                    { name: "Principal & Interest", value: FHAPrincipalInterest },
                    { name: "Taxes", value: PropertyTaxes },
                    { name: "Insurance", value: FHAMortgageInsurance },
