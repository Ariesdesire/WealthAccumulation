...
import DemoCoverflow from "./PRopertyImagesSwipeable";
    ...
    render () {
        return (
            <React.Fragment>
                ...
                <Box color="text.primary" display="flex" justifyContent="space-around"   p={2} m={2}>
                <p>Bedrooms {this.state.movie.totalBedrooms}</p>
                ...
                <DemoCoverflow />
                <Typography  p={2} variant="body1" gutterBottom>
                    <strong> Brokers remarks</strong>  {this.state.movie.brokerRemarks}
                </Typography>
