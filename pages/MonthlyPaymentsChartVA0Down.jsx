...
export default class MonthlyPaymentChartVa0Down extends React.Component {
    ...
    componentDidMount() {
        ...
        api.get_payment(movie_id)
            .then(result => {
                ...
                const VaPrincipalInterest0Down = Number(result.VaPrincipalInterest0Down);
                const PropertyTaxes = Number(result.PropertyTaxes);
                const HOAFees = Number(result.HOAFees);
                return [
                    { name: "Principal & Interest", value: VaPrincipalInterest0Down },
