...
export default class MonthlyPaymentChartVa10Down extends React.Component {
    ...
    componentDidMount() {
        ...
        api.get_payment(movie_id)
            .then(result => {
                ...
                const VaPrincipalInterest10Down = Number(result.VaPrincipalInterest10Down);
                const PropertyTaxes = Number(result.PropertyTaxes);
                const HOAFees = Number(result.HOAFees);
                return [
                    { name: "Principal & Interest", value: VaPrincipalInterest10Down },
